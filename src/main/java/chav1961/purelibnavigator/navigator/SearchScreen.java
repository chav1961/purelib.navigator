	...
	public SearchScreen(final Localizer localizer, final LoggerFacade logger) throws SyntaxException, LocalizationException, ContentException {
		try(final LoggerFacade	tran = logger.transaction("SearchScreen")) {
			...
			final JPanel		leftTopPanel = new AutoBuiltForm<NavigationFilter>(mdi,localizer, PureLibSettings.INTERNAL_LOADER, filter, new FormManager<Object, NavigationFilter>() {
									@Override
									public RefreshMode onField(NavigationFilter inst, Object id, String fieldName, Object oldValue, boolean beforeCommit) throws FlowException, LocalizationException {
